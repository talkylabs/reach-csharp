...
{
    /// <summary>
    /// Base http client used to make Reach requests
    /// </summary>
    public abstract class HttpClient
    {
        ...
        /// <summary>
        /// Make a request to Reach, returns non-2XX responses as well
        /// </summary>
        ///
...
#if !NET35
        /// <summary>
        /// Make an async request to Reach, returns non-2XX responses as well
        /// </summary>
        ///
        /// <param name="request">request to make</param>
        /// <exception>throws exception on network or connection errors.</exception>
