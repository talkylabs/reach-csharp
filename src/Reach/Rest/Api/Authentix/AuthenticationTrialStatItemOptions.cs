...
namespace Reach.Rest.Api.Authentix
{
    ...
    public class FetchAuthenticationTrialStatItemOptions : IOptions<AuthenticationTrialStatItemResource>
    {
    
        ///<summary> Filter authentication trials sent only to this phone number or email. The phone number must be in the E.164 format. </summary> 
        public string Dest { get; set; }

        ///<summary> Filter authentication trials with the specified status. </summary> 
        public AuthenticationTrialStatItemResource.TrialStatusEnum TrialStatus { get; set; }

        ///<summary> Filter authentication trials sent via the specified channel. </summary> 
        public AuthenticationTrialStatItemResource.ChannelEnum Channel { get; set; }

        ///<summary> Filter authentication trials from the configuration whose ID matches the specified one. </summary> 
        public string ConfigurationId { get; set; }

        ///<summary> Filter authentication trials from the authentication whose ID matches the specified one. </summary> 
        public string AuthenticationId { get; set; }

        ///<summary> Filter authentication trials sent to the specified destination country (in ISO 3166-1 alpha-2). Only possible when `dest` is a phone number. </summary> 
        public string Country { get; set; }

        ///<summary> Filter authentication trials created at the specified date. Must be in ISO 8601 format. </summary> 
        public DateTime? SentAt { get; set; }

        ///<summary> Filter authentication trials created after the specified datetime. Must be in ISO 8601 format. </summary> 
        public DateTime? SentAfter { get; set; }

        ///<summary> Filter authentication trials created before the specified datetime. Must be in ISO 8601 format. </summary> 
